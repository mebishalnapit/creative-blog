 ...
 * @uses creative_blog_admin_header_style()
 * @uses creative_blog_admin_header_image()
 */
function creative_blog_custom_header_setup() {
    add_theme_support('custom-header', apply_filters('creative_blog_custom_header_args', array(
        ...
        'admin-head-callback' => 'creative_blog_admin_header_style',
        'admin-preview-callback' => 'creative_blog_admin_header_image',
    )));
}
...
if (!function_exists('creative_blog_admin_header_style')) :
     ...
     * @see creative_blog_custom_header_setup().
     */
    function creative_blog_admin_header_style() {
        ?>
        <style type="text/css">
...
endif; // creative_blog_admin_header_style

if (!function_exists('creative_blog_admin_header_image')) :
     ...
     * @see creative_blog_custom_header_setup().
     */
    function creative_blog_admin_header_image() {
        ?>
        <div id="headimg">
