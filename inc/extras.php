...
if (!function_exists('creative_blog_footer_copyright')) :
    ...
    function creative_blog_footer_copyright() {
        ...
        $my_link_name = __('Bishal Napit', 'creative-blog');
